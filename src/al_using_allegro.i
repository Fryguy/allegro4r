...
static VALUE a4r_allegro_init(VALUE self)
{
  return INT2FIX(allegro_init());
}

static VALUE a4r_allegro_exit(VALUE self)
{
  allegro_exit();
  return Qnil;
}

static VALUE a4r_allegro_error(VALUE self)
{
  // TODO: Convert to data struct or cached or hooked variable?
  return rb_str_new2(allegro_error);
}

static VALUE a4r_allegro_message(VALUE self, VALUE text)
{
