...
module Config
  ...
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/mingw/ruby")
  CONFIG["EXEEXT"] = ".exe"
  ...
  CONFIG["CC"] = "gcc"
  CONFIG["CFLAGS"] = "-pipe -O2 -mms-bitfields -march=i686  $(cflags)"
  CONFIG["LDFLAGS"] = "-L. "
  ...
  CONFIG["configure_args"] = " '--host=i586-mingw32msvc' '--target=i386-mingw32' '--build=i686-linux' '--prefix=/mingw/ruby' 'build_alias=i686-linux' 'host_alias=i586-mingw32msvc' 'target_alias=i386-mingw32' 'CFLAGS=-pipe -O2 -mms-bitfields -march=i686'"
